...
public class PriceProcessStatelessTest {
    ...
    public void testEmptyShoppingCard() throws Exception {
        ...
        commands.add(commandsFactory.newStartProcess("org.jboss.btison.bpms.tests.pricing.PriceProcess"));
    ...
    public void testShoppingCardWithProduct() throws Exception {
		...
		try {
			results = kSession.execute(executionCommand);
			Assert.fail();
