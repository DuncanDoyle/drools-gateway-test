...
public class ShoppingCart implements java.io.Serializable
{
   ...
   private java.util.List<ShoppingCartItem> shoppingCartItemList;

   public ShoppingCart()
   {
   }

   public java.util.List<ShoppingCartItem> getShoppingCartItemList()
   {
      return this.shoppingCartItemList;
   }

   public void setShoppingCartItemList(java.util.List<ShoppingCartItem> shoppingCartItemList)
   {
   ...
   public ShoppingCart(
         ...
         java.util.List<ShoppingCartItem> shoppingCartItemList)
   {
      this.cartItemPromoSavings = cartItemPromoSavings;
      this.cartItemTotal = cartItemTotal;
      this.cartTotal = cartTotal;
